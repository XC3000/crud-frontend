                ...
                <FormGroup>
                    {this.state.errors["cust_name"].length > 0 && (
                        <div className="alert alert-danger">
                            this.state.errors["cust_name"].map({(item) => item})
                        </div>
                    )}
